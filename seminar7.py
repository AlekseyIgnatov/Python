...
def f(str):
    return sum(1 for i in str if i in 'аеёиоуыэюя')
    
    
str_osn = 'пара-ра-рам рам-пам-папам па-ра-па-дам'
str = str_osn.split()
count = f(str[0])
if all([f(i) == count for i in str]):
    print('Парам пам-пам')
else:
    print('Пам парам')
...
# myfunc.print_operation_table(lambda x, y: x * y)